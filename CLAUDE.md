...
- **Migrations:** `drizzle/migrations/` — generated by `npx drizzle-kit generate`, applied with `wrangler d1 migrations apply dearapplicant`
...
3. `wrangler d1 migrations apply dearapplicant` → apply to D1 (add `--local` for local dev)
